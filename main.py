...
@app.post("/compile_images")
async def compile_images(data:CompileImages):
...
async def search_image(data: SearchImage):
    ...
    return {"status": "success", "result": [images[index] for index in i[0]]}